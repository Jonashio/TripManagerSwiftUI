...
struct TripListViewCell_Previews: PreviewProvider {
    static var previews: some View {
        TripListViewCell(model: .constant(TripModel(status: nil, stops: nil, origin: nil, startTime: "2018-12-18T08:00:00.000Z", tripModelDescription: nil, endTime: "2018-12-18T09:00:00.000Z", route: nil, destination: nil, driverName: "Jona"))) { model in
            // nothing
        }
    }
}
